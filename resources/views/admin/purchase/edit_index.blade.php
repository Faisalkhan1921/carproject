      ...
      <div class="row mt-5">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Edit Purchase
                            <a href="{{route('admin.purchase.index')}}" class="btn btn-warning btn-sm float-right">Return to List</a>
                            </h5>
                            
                        </div>
                        <div class="card-body">
                           <form action="{{route('admin.purchase.update',$users->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
        ...
        @endif
                           ...
                           <input type="submit" value="Update Purchase Record" class="form-control btn btn-primary">
