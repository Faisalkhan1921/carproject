...
Sliders
    <a href="{{route('admin.slider.add')}}" class="btn btn-success btn-sm btn-sm"  id="btn-add"><i class="fa-solid fa-square-plus text-light"></i> Add New</a>
    ...
    <!-- <a href="#" class="btn btn-danger btn-sm" id="btn-bulk-delete"><i class="fa-solid fa-trash text-light"></i> Bulk Delete</a> -->
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Slider Records
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered users-table"  id="dataTable"  width="100%" cellspacing="0">
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                             <a href="{{route('admin.slider.view',$item->id)}}" class="btn btn-warning btn-sm">View</a>
                                             <a href="{{route('admin.slider.edit',$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                             <a href="{{route('admin.slider.delete',$item->id)}}" onclick="return confirm('Are You Sure Want To Delete This?')" class="btn btn-danger btn-sm">Delete</a>
                                     </td>
                                     </tr>
                                 @endforeach
...
function handleSubmit() {
    ...
    if (selectedAction === 'archive') {
        document.getElementById('archiveForm').action = "{{ route('admin.slider.bulkdelete') }}";
