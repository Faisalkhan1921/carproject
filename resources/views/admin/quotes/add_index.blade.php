      ...
      <div class="row mt-5">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Add Motivational Quotes
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quote" id="" class="form-control" placeholder="Enter Motivational Quote">
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        inputDate.addEventListener('input', function() {
            ...
            if (disableDates(selectedDate)) {
                this.setCustomValidity('Motivational Quote already exist on this date.');
            } else {
                this.setCustomValidity('');
            }
        });

        // Initial check if today's date is disabled
        if (disableDates(new Date(today))) {
            inputDate.setCustomValidity('Today is disabled.');
        } else {
            inputDate.setCustomValidity('');
                           ...
                           <input type="submit" value="Add Motivational Quote" class="form-control btn btn-primary">
