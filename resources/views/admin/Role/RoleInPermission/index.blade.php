...
Roles
    <a href="{{route('admin.rp.add')}}" class="btn btn-success btn-sm btn-sm"  id="btn-add"><i class="fa-solid fa-square-plus text-light"></i> Add RoleInPermission</a>
    ...
    <!-- <a href="#" class="btn btn-danger btn-sm" id="btn-bulk-delete"><i class="fa-solid fa-trash text-light"></i> Bulk Delete</a> -->
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">RoleInPermission Records
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                        @foreach($item->permissions as $prem)
                                            <span class="badge bg-primary text-light">{{$prem->name}}</span>
                                        @endforeach
                                     ...
                                     <td>
                                             <a href="{{route('admin.rp.edit',$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                             <a href="{{route('admin.rp.delete',$item->id)}}" onclick="return confirm('Are You Sure Want To Delete This?')" class="btn btn-danger btn-sm">Delete</a>
                                     </td>
                                     </tr>
                                 @endforeach
