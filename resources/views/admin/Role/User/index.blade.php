...
<!-- <i class="fas fa-user-crown text-dark"></i> -->
<i class="fa-solid fa-user-tie"></i>
All Admins User
    <a href="{{route('admin.user.add')}}" class="btn btn-success btn-sm btn-sm"  id="btn-add"><i class="fa-solid fa-square-plus text-light"></i> Add New Admin</a>
    ...
    <!-- <a href="#" class="btn btn-danger btn-sm" id="btn-bulk-delete"><i class="fa-solid fa-trash text-light"></i> Bulk Delete</a> -->
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">All Admin Users Records
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered users-table"  id="dataTable"  width="100%" cellspacing="0">
                                 ...
                                 <tr>
                                    ...
                                    $role = App\Models\AdminRoles::where('id',$item->role_id)->first();
                                    if($role)
                                    {
                                    ...
                                    else 
                                    {
                                     ...
                                     @endphp
                                     <td><span class="badge text-light bg-danger">
                                     {{$role_name}}
                                     </span></td>
                                     <td>
                                        <img src="{{asset('storage/'.$item->avatar)}}" width="100px" height="100px" alt="">
                                     </td>
                                     ...
                                     <td>
                                             <a href="{{route('admin.user.edit',$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                             <a href="{{route('admin.user.delete',$item->id)}}" onclick="return confirm('Are You Sure Want To Delete This?')" class="btn btn-danger btn-sm">Delete</a>
                                     </td>
                                     </tr>
                                 @endforeach
