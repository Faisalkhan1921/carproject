...
<h1 class="text-center" style="color:black;">{{$user_name}} Monthly Progress</h1>
...
<a href="{{route('admin.routine.monthly_progress',$user_id)}}" class="btn btn-success">Monthly Progress</a>
    ...
    <div class="col-md-3">
        <form action="{{route('admin.routine.search_month_progress',$user_id)}}" method="get">
            ...
            <input type="submit" value="Search Month" class="btn btn-primary form-control">
        </form>
    </div>
</div>
    <div class="calendar">
