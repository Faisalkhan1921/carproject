...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{route('admin.assignplan.update1cardioawr')}}" method="post">
        @csrf
        <input type="text" name="cardio_day" value="{{$cardio_day}}">
        <input type="text" name="cardio_id" value="{{$routine_id}}">
