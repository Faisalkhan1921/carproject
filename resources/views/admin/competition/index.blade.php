    ...
    <!-- <a href="#" class="btn btn-danger btn-sm" id="btn-bulk-delete"><i class="fa-solid fa-trash text-light"></i> Bulk Delete</a> -->
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Competition Entries Records
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$item->answer}}</td>
                                                    @php 
                                                    $message = App\Models\Carousel::where('id',$item->carousel_id)->first();
                                                    if($message)
                                                    {
                                                        $title = $message->title;
                                                    }
                                                    ...
                                                    <td>
                                                            <a href="{{route('admin.comp.view',$item->id)}}" class="btn btn-warning btn-sm">View</a>
                                                            <a href="{{route('admin.comp.edit',$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                                            <a href="{{route('admin.comp.delete',$item->id)}}" onclick="return confirm('Are You Sure Want To Delete This?')" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                    </tr>
                                                @endforeach
