      ...
      <div class="row mt-5">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Edit Competition Entry
                            <a href="{{route('admin.comp.index')}}" class="btn btn-warning btn-sm float-right">Return to List</a>
                            </h5>
                            
                        </div>
                        <div class="card-body">
                           <form action="{{route('admin.comp.update',$users->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" id="" class="form-control" value="{{$users->phone}}">
                        </div>

                        
                        <div class="form-group">
                            <label for="">Answer</label>
                            <input type="text" name="answer" id="" class="form-control" value="{{$users->answer}}">
                        </div>
                           ...
                           <div class="form-group">
                            ...
                            {{$users->carousel_id == $item->id ? 'selected' : ''}}
                            >{{$item->title}}</option>
                            @endforeach
                        </select>
                           ...
                           <input type="submit" value="Update Competition Entry" class="form-control btn btn-primary">
