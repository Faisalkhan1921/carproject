    ...
    <!-- <a href="#" class="btn btn-danger btn-sm" id="btn-bulk-delete"><i class="fa-solid fa-trash text-light"></i> Bulk Delete</a> -->
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Customer Module Records
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered users-table"  id="dataTable"  width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <!-- <th>Sno</th> -->
                                            <th>SelectedModule</th>
                                            <th>UserAllotedTo</th>
                                            <th>ModuleAllotedOn</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                 ...
                                 <tr>
                                     ...
                                     <td>{{$item->allotedModule->title}}</td>
                                     @php 
                                    ...
                                    else 
                                    {
                                     ...
                                     <td>
                                             <a href="{{route('admin.module.view',$item->id)}}" class="btn btn-warning btn-sm">View</a>
                                             <a href="{{route('admin.module.edit',$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                             <a href="{{route('admin.module.delete',$item->id)}}" onclick="return confirm('Are You Sure Want To Delete This?')" class="btn btn-danger btn-sm">Delete</a>
                                     </td>
                                     </tr>
                                 @endforeach
